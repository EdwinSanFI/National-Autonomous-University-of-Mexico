...
int main() {
    ...
    agregarPrincipioNodoDoble(&listaCircularDoble, 1);
    agregarPrincipioNodoDoble(&listaCircularDoble, 2);
    agregarPrincipioNodoDoble(&listaCircularDoble, 3);
    agregarPrincipioNodoDoble(&listaCircularDoble, 4);
    agregarPrincipioNodoDoble(&listaCircularDoble, 5);
    agregarPrincipioNodoDoble(&listaCircularDoble, 6);
    imprimirListaDoble(listaCircularDoble);

    agregarFinalNodoDoble(&listaCircularDoble, 7);
    agregarFinalNodoDoble(&listaCircularDoble, 8);
    agregarFinalNodoDoble(&listaCircularDoble, 9);
    imprimirListaDoble(listaCircularDoble);

    eliminarInicioNodoDoble(&listaCircularDoble);
    imprimirListaDoble(listaCircularDoble);

    eliminarFinalNodoDoble(&listaCircularDoble);
    imprimirListaDoble(listaCircularDoble);
}
